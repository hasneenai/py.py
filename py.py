...
while True:
	...
	us = str(''.join(random.choice('qwertyuioplkjhgfdsazxcvbnm')for i in range(5)))
	
	h = ["qwerty","abc123","password1","iloveyou","1q2w3e4r","qwerty123","zaq12wsx","dragon","sunshine","princess","letmein","monkey","1qaz2wsx","qwertyuiop","superman","asdfghjkl"]
	pas = random.choice(h)
